...
module.exports = genRandomOp = (data) ->
  ...
  op = while randomReal() < pct
    ...
    # if operand is string, dont generate the related test
    else if typeof operand == 'string'
      continue
      # throw new Error "Text0 related tests are temporarily removed. Text0 is not implemented"
