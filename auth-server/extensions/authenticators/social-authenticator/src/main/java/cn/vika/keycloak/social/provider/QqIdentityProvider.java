...
public class QqIdentityProvider extends AbstractOAuth2IdentityProvider<JustIdentityProviderConfig> implements SocialIdentityProvider<JustIdentityProviderConfig> {
    /**
     * 发起授权时默认请求作用域
     */
     ...
     * 授权地址
     */
    private final static String QQ_AUTHORIZE_URL = "https://graph.qq.com/oauth2.0/authorize";

    public static final String OAUTH2_PARAMETER_WHICH = "which";
    public static final String OAUTH2_PARAMETER_DISPLAY = "display";
    public static final String OAUTH2_PARAMETER_LOGIN = "Login";
    public static final String OAUTH2_PARAMETER_DISPLAY_PC = "pc";
    public static final String OAUTH2_PARAMETER_DISPLAY_MOBILE = "mobile";

    public QqIdentityProvider(KeycloakSession session, JustIdentityProviderConfig config) {
    ...
    protected UriBuilder createAuthorizationUrl(AuthenticationRequest request) {
        ...
        UserAgent ua = UserAgentUtil.parse(request.getHttpRequest().getHttpHeaders().getHeaderString(USER_AGENT));

        String display = OAUTH2_PARAMETER_DISPLAY_PC;
        if (Objects.nonNull(ua) && ua.isMobile()) {
            display = OAUTH2_PARAMETER_DISPLAY_MOBILE;
        }

        // 构造QQ授权链接
        String gotoUrl = UrlBuilder.fromBaseUrl(QQ_AUTHORIZE_URL)
                .queryParam(OAUTH2_PARAMETER_WHICH, OAUTH2_PARAMETER_LOGIN)
                .queryParam(OAUTH2_PARAMETER_DISPLAY, display)
    ...
    protected class Endpoint {
        ...
        public Response authResponse(@QueryParam(OAUTH2_PARAMETER_STATE) String state,
            ...
            try {
                ...
                authConfig.setUnionId(Boolean.TRUE);
                ...
                if (response.ok()) {
                    ...
                    BrokeredIdentityContext user = IdentityProviderUtil.getBrokeredIdentityContext(userEntity, getConfig(), QqIdentityProvider.this);
