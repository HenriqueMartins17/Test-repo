...
import com.vikadata.social.service.dingtalk.autoconfigure.DingTalkProperties.AgentAppProperty;
import com.vikadata.social.service.dingtalk.autoconfigure.DingTalkProperties.IsvAppProperty;
...
@ConditionalOnProperty(value = "starter.social.dingtalk.enabled", havingValue = "true")
public class DingTalkAutoConfiguration implements ApplicationContextAware, BeanDefinitionRegistryPostProcessor,
    ...
    public void postProcessBeanDefinitionRegistry(@NonNull BeanDefinitionRegistry registry) throws BeansException {
        BindResult<DingTalkProperties> bind = Binder.get(environment).bind("starter.social.dingtalk", Bindable.of(DingTalkProperties.class));
        properties = bind.get();
        if (properties == null) {
            return;
        }
