...
import com.vikadata.scheduler.space.util.DigestUtil;
import com.vikadata.scheduler.space.util.InputStreamCache;
import com.vikadata.scheduler.space.util.MimeTypeMapping;
...
public class SpaceAssetServiceImpl implements ISpaceAssetService {
    ...
    private AssetDto getObjectFromCloud(String path) {
        OssObject object = qiniuService.getObject(configProperties.getOssBucketName(), path);
        if (object == null) {
            return null;
        }
