    ...
    <div className={'vk-p-4 vk-w-3/4'}>
      ...
      <div className={'vk-flex vk-my-4 vk-space-x-10'}>
        <ConfigItem
          ...
          content={<Typography variant={'body2'}>{dayjs(trainInfo.startedAt).format('YYYY-MM-DD HH:mm:ss')}</Typography>}
        />
        <ConfigItem
          titleConfig={{
            icon: <TimeOutlined />,
          ...
          content={<Typography variant={'body2'}>{trainInfo.status}</Typography>}
        />
        <ConfigItem
          titleConfig={{
            icon: <TimeOutlined />,
          ...
          content={<Typography variant={'body2'}>{trainInfo.creditCost}</Typography>}
        />
      </div>
