...
// @ts-ignore
import { WecomOpenData, WecomOpenDataType } from 'enterprise/wecom/wecom_open_data/wecom_open_data';
...
export const isDingtalkFunc = () => !process.env.SSR && navigator.userAgent.toLowerCase().indexOf('dingtalk') > -1;
      ...
      label: (
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          {/* <span>{t(Strings.social_plat_space_list_item_seats_msg, { max: item.maxSeat })}</span> */}
          {
            ...
            <Image src={SocialPlatformMap[item.social.platform].logo} width={24} height={24} alt="" />
          }
        </div>
      ),
    });
