...
import { IdentifyingCodeModes, IIdentifyingCodeConfig } from '../../../home';
...
export const initMode = (mode?: IdentifyingCodeModes): IdentifyingCodeModes => {
  ...
  if (LOGIN_DEFAULT_ACCOUNT_TYPE) {
    return LOGIN_DEFAULT_ACCOUNT_TYPE.split(',')[0] as IdentifyingCodeModes;
  }
...
const IdentifyingCodeLoginBase: FC<IIdentifyingCodeLoginProps> = (
  ...
  const handleModeChange = (mode: IdentifyingCodeModes) => {
    setErrMsg({ identifyingCodeErrMsg: '', accountErrMsg: '' });
