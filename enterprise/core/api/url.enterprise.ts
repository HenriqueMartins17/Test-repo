...
export const WOA_CALLBACK = '/social/woa/user/login';
export const WOA_REFRESH_CONTACT = '/social/woa/refresh/contact';
 ...
 * APITable Cloud
 */
export const APITABLE_CHANGE_PASSWORD = '/user/resetPassword';

export const APITABLE_RESENT_VERIFY_EMAIL = '/user/verifyEmail';

export const BILLING_SUBSCRIPTION = '/billing/subscriptions';
export const UPDATE_SUBSCRIPTION = '/billing/updateSubscription';
export const CHANGE_PAYMENT_METHOD = '/billing/changePaymentMethod';
export const CANCEL_SUBSCRIPTION = '/billing/cancelSubscription';
export const GET_INVOICES = '/billing/invoices';
export const CHANGE_PLAN_USER_INFO = 'billing/customers/portal';

// =============== workdoc info =======================
export const GET_WORKDOC_INFO = '/documents/:documentId';
