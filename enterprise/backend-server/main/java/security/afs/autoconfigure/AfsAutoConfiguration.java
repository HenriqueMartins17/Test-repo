...
@ConditionalOnProperty(value = "afs.enabled", havingValue = "true")
@Import({ AliyunAfsAutoConfiguration.class })
public class AfsAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean
    public AfsChecker afsChecker(final AfsCheckerFactory afsCheckerFactory) {
        return afsCheckerFactory.createChecker();
    }
