...
/**
 * stripe price config in live mode.
 */
@Deprecated(since = "1.7.0", forRemoval = true)
public class StripePriceLiveConfigLoader {
    ...
    private enum Singleton {
        ...
        Singleton() {
            try {
                InputStream resourceAsStream =
                    StripePriceLiveConfigLoader.class.getResourceAsStream(
                        "/enterprise/config/stripe_price_live.json");
        ...
        public StripePriceConfig getSingleton() {
            return singleton;
        }
    }
}
