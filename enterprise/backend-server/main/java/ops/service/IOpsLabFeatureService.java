...
/**
 * <p>
 * Product Operation System - Lab Feature Service.
 * </p>
 */
public interface IOpsLabFeatureService {

    /**
     * Create laboratory feature.
     */
    void create(LabsFeatureEnum feature, LabsFeatureScopeEnum scope,
                LabsFeatureTypeEnum type, String url);

    /**
     * Modify laboratory feature.
     */
    void edit(String featureKey, String scope, String type, String url);

    /**
     * Remove laboratory feature.
     */
    void remove(String featureKey);

    /**
     * Open laboratory feature for applicants.
     */
    void apply(String featureKey, String uuid, String spaceId);
}
