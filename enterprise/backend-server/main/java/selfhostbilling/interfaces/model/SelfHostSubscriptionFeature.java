...
/**
 * self-host subscription feature.
 *
 * @author Shawn Deng
 */
public class SelfHostSubscriptionFeature implements SubscriptionFeature {
    ...
    @Override
    public SubscriptionFeatures.SubscribeFeatures.AuditQuery getAuditQuery() {
        return new SubscriptionFeatures.SubscribeFeatures.AuditQuery(true);
    }
    ...
    public SubscriptionFeatures.ConsumeFeatures.AiAgentNums getAiAgentNums() {
        return new SubscriptionFeatures.ConsumeFeatures.AiAgentNums(-1L);
    }

    public SubscriptionFeatures.ConsumeFeatures.MessageCreditNums getMessageCreditNums() {
        return new SubscriptionFeatures.ConsumeFeatures.MessageCreditNums(-1L);
    }
