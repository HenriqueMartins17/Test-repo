...
import com.apitable.enterprise.notification.core.VikaMailTemplateLoader;
import java.io.IOException;
import java.util.Locale;
import java.util.Properties;

/**
 * Vika Mail Facade Implement Class.
 *
 * @author Chambers
 */
public class VikaMailFacadeImpl extends AbstractEnterpriseMailFacade {

    private static final String RESOURCE_PATH_PREFIX =
        "templates/notification/enterprise/vika-saas";
    ...
    public Long getCloudMailTemplateId(final String lang, final String subject) {
        return VikaMailTemplateLoader.getTemplateId(lang, subject);
    }
    ...
    public Properties getSubjectProperties(final String locale) throws IOException {
        return super.getProperties(RESOURCE_PATH_PREFIX, locale,
    ...
    public String loadTemplateResourcePath(final String locale, final String templateName) {
        return super.loadTemplateResourcePath(RESOURCE_PATH_PREFIX,
            templateName, locale, Locale.SIMPLIFIED_CHINESE.toLanguageTag());
    }
}
