...
import com.apitable.enterprise.apitablebilling.mapper.SubscriptionHistoryInApitableMapper;
 ...
 */
@Service
public class SubscriptionHistoryInApitableServiceImpl
    extends ServiceImpl<SubscriptionHistoryInApitableMapper, SubscriptionHistoryEntity> implements
    ISubscriptionHistoryInApitableService {
    ...
    private SubscriptionHistoryEntity build(SubscriptionEntity entity, ChangeType changeType) {
        ...
        subscriptionHistoryEntity.setStripeId(entity.getStripeId());
        subscriptionHistoryEntity.setStripeSubId(entity.getStripeSubId());
        ...
        subscriptionHistoryEntity.setPriceId(entity.getPriceId());
        subscriptionHistoryEntity.setPeriod(entity.getPeriod());
        subscriptionHistoryEntity.setQuantity(entity.getQuantity());
