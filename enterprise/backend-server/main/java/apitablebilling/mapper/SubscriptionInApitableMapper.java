 ...
 */
public interface SubscriptionInApitableMapper extends BaseMapper<SubscriptionEntity> {
     ...
     * @return bundle list
     */
    List<SubscriptionEntity> selectBySubscriptionIds(
     ...
     */
    Integer updateIsDeletedBySubscriptionIds(@Param("subscriptionIds") List<String> subscriptionIds,
                                             @Param(
    ...
    IPage<SpaceSubscriptionDto> selectUnExpireCapacityBySpaceId(@Param("spaceId") String spaceId,
                                                                Page page, @Param("state")
     ...
     * @return Page
     */
    IPage<SpaceSubscriptionDto> selectExpireCapacityBySpaceId(@Param("spaceId") String spaceId,
                                                              Page page);
     ...
     */
    @InterceptorIgnore(illegalSql = "true")
    Integer selectUnExpireGiftCapacityBySpaceId(@Param("spaceId") String spaceId,
     ...
     */
    String selectSubscriptionIdBySpaceIdAndPhaseIgnoreDeleted(@Param("spaceId") String spaceId,
     ...
     */
    List<String> selectBundleIdsBySubscriptionIds(
        @Param("subscriptionIds") List<String> subscriptionIds);
}
