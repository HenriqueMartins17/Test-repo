 ...
 * @author Shawn Deng
 */
@ConfigurationProperties(prefix = "social.dingtalk")
public class DingTalkProperties {
     ...
     */
    private Boolean syncContactWithTree = false;
    ...
    public Boolean getSyncContactWithTree() {
        return syncContactWithTree;
    }

    public void setSyncContactWithTree(Boolean syncContactWithTree) {
        this.syncContactWithTree = syncContactWithTree;
    }
