 ...
 */
@Service
public class SocialCpIsvChangeAppAdminEntityHandler
    ...
    public boolean process(SocialCpIsvEventLogEntity unprocessed) throws WxErrorException {
        ...
        WxCpIsvAdmin wxCpIsvAdmin = wxCpIsvService.getAuthCorpAdminList(authCorpId,
            Integer.parseInt(xmlMessage.getAgentID()));
        ...
        if (CollUtil.isEmpty(adminOpenIds)) {
        ...
        } else if (Objects.isNull(adminMember) ||
            !CollUtil.contains(adminOpenIds, adminMember.getOpenId())) {
            ...
            for (WxCpIsvAdmin.Admin isvAdmin : isvAdmins) {
                boolean viewable =
                    socialCpIsvService.judgeViewable(authCorpId, isvAdmin.getUserId(), suiteId,
                ...
                if (viewable) {
                    ...
                    socialCpIsvService.syncSingleUser(authCorpId, isvAdmin.getUserId(), suiteId,
                        spaceId, true);
