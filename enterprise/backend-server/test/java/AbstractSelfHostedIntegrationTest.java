...
@ContextConfiguration(initializers = {
    ...
    TestSelfhostContextInitializer.class
})
public abstract class AbstractSelfHostedIntegrationTest extends AbstractIntegrationTest {

    private final static Logger log =
        LoggerFactory.getLogger(AbstractSelfHostedIntegrationTest.class);
