...
@ContextConfiguration(initializers = {
    ...
    TestAliyunContextInitializer.class
})
public abstract class AbstractAliyunIntegrationTest extends AbstractIntegrationTest {

    private final static Logger log =
        LoggerFactory.getLogger(AbstractAliyunIntegrationTest.class);
